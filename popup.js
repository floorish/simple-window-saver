...
function init() {
    ...
    //backgroundPage.init(function() {
        ...
        chrome.windows.getCurrent(function(currentWindow) {
            ...
            var sessions = backgroundPage.sessions;

            for (var name in sessions) {

                appendWindowToList(sessions[name], currentWindowName);

            }


            // if current window is not stored
...
function saveWindow(event) {
    ...
    chrome.windows.getCurrent(function(currentWindow) {
        ...
        chrome.tabs.getAllInWindow(null, function(tabs) {
            ...
            savedWindow = backgroundPage.createSession(currentWindow, nameInput.value);
...
function openSavedWindow(event) {
    ...
    backgroundPage.openSession(name);

    //var savedWindow = backgroundPage.sessions[name];
...
function deleteSavedWindow(event) {
    ...
    //backgroundPage.deleteSession(name);
    backgroundPage.SessionStorage.remove(name);
...
function undoDeleteSavedWindow(event) {
    ...
    // resave the window
    backgroundPage.createSession(savedWindow, name);
